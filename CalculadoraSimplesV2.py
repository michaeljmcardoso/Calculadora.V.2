...
btp=Button(calc,font=('arial',15,'bold'),command=lambda:click('.'),bg="lavender",text=".",bd=5,padx=15,pady=10).grid(row=5,column=3)

bte=Button(calc,font=('arial',15,'bold'),command=lambda:click('**'),bg="lavender",text="**",bd=5,padx=15,pady=10).grid(row=5,column=2)

btr=Button(calc,font=('arial',15,'bold'),command=lambda:click('%'),bg="lavender",text="%",bd=5,padx=15,pady=10).grid(row=5,column=1)

btv=Button(calc,font=('arial',15,'bold'),command=lambda:click(' '),bg="lavender",text=" ",bd=5,padx=15,pady=10).grid(row=5,column=0)
